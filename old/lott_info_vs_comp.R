...
#
# The added novel feature of this version is additional code to parse the 
# contributions of information due to matching the environment from those 
# due to avoiding competition. 
#
#=============================================================================
#=============================================================================
#Load libraries
...
env_fit = NULL
env_fit$Ni = Ni
env_fit$Ni_comp = Ni #Simple population dynamics, no niches
env_fit$Ni_niche = Ni #Simple population dynamics, niches
env_fit$Ni2_comp = Ni #Population dynamics of residents, niche partitioning 
env_fit$Ni2_niche = Ni #Population dynamics of residents, niche partitioning 
env_fit$opt_comp = c(0.5,0.5) #The same for no niches
env_fit$opt_niche = c(0.3,0.7) #Different, for niches
...
env_fit$g_mean_comp = env_fit$opt_comp 
env_fit$g_mean_niche = env_fit$opt_niche 
